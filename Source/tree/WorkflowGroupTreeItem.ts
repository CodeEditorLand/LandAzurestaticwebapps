...
export class WorkflowGroupTreeItem extends AzExtParentTreeItem {
	public static contextValue = "azureStaticWorkflowGroup";
	...
	public get label(): string {
		return this.parseYamlError
			? localize("invalidWorkflow", "Invalid Workflow")
			: localize("workflow", "Workflow");
	}
	...
	public static async createGitHubConfigGroupTreeItems(
		...
		if (parent.localProjectPath && parent.inWorkspace) {
			...
			context.telemetry.properties.numWorkflows =
				yamlFiles.length.toString();
	...
	public get errorRange(): Range | undefined {
		return this.parseYamlError instanceof YAMLSyntaxError
			? getRangeFromError(this.parseYamlError)
			: undefined;
	}
