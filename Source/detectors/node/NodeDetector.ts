			...
			for (const framework of Object.keys(
				...
				if (devDependencies[framework]) {
					detectedFrameworkResult.push({
						framework:
							NodeConstants.DevDependencyFrameworkKeyWordToName[
								framework as keyof typeof NodeConstants.DevDependencyFrameworkKeyWordToName
							],
						version: devDependencies[framework],
					});
				}
			}
		}
			...
			for (const framework of Object.keys(
				...
				if (dependencies[framework]) {
					detectedFrameworkResult.push({
						framework:
							NodeConstants.DependencyFrameworkKeyWordToName[
								framework as keyof typeof NodeConstants.DependencyFrameworkKeyWordToName
							],
						version: dependencies[framework],
					});
				}
			}
		}
