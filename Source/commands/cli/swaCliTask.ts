...
const runningSwaTaskMap: Map<
	vscode.WorkspaceFolder | vscode.TaskScope,
	IRunningSwaTask
> = new Map<vscode.WorkspaceFolder | vscode.TaskScope, IRunningSwaTask>();

export function registerSwaCliTaskEvents(): void {
	registerEvent(
		"staticWebApps.onDidTerminateDebugSession",
	...
	registerEvent(
		...
		async (context: IActionContext, e: vscode.TaskProcessStartEvent) => {
			...
			if (
				...
				runningSwaTaskMap.set(e.execution.task.scope, {
