...
import {
	angularOutputLocation,
	appArtifactSubpathSetting,
	...
	public async prompt(context: IStaticWebAppWizardContext): Promise<void> {
		...
		context.outputLocation = (
			await context.ui.showInputBox({
				...
				prompt: localize(
					"publishLocation",
					"Enter the location of your build output relative to your app's location or leave blank if it has no build. For example, setting a value of 'build' when your app location is set to 'app' will cause the content at 'app/build' to be served.",
				),
