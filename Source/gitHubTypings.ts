...
export type OrgForAuthenticatedUserData =
	Endpoints["GET /user"]["response"]["data"];

export type ListOrgsForUserData =
	Endpoints["GET /user/orgs"]["response"]["data"][0];
...
export type ActionsGetJobForWorkflowRunResponseData =
...
export type ActionsGetWorkflowResponseData =
	Endpoints["GET /repos/{owner}/{repo}/actions/workflows/{workflow_id}"]["response"]["data"];

export type ActionsListWorkflowRunsForRepoResponseData =
	Endpoints["GET /repos/{owner}/{repo}/actions/runs"]["response"]["data"];

export type JobLogsForWorkflowRun =
	Endpoints["GET /repos/{owner}/{repo}/actions/jobs/{job_id}/logs"]["response"]["data"];
...
export type ReposCreateForkResponse =
	RestEndpointMethodTypes["repos"]["createFork"]["response"];
